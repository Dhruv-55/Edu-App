   ...
   <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('batch-view')}}" class="menu-link">
              <div data-i18n="Without menu">View</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="{{ route('batch-subject-view')}}" class="menu-link">
              <div data-i18n="Without menu">Assign Subject</div>
            </a>
          </li>
        </ul>
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('subject-view')}}" class="menu-link">
              <div data-i18n="Without menu">View</div>
            </a>
          </li>
        </ul>
